...
public class EventSubscriptionTransformer implements IClassTransformer {
    ...
    private boolean buildEvents(ClassNode classNode) throws Exception {
        ...
        // Class<?> listenerListClazz = Class.forName("cpw.mods.fml.common.eventhandler.ListenerList", false,
        ...
        String voidDesc = getMethodDescriptor(VOID_TYPE);
        String boolDesc = getMethodDescriptor(BOOLEAN_TYPE);
        String listDesc = tList.getDescriptor();
        String listDescM = getMethodDescriptor(tList);
